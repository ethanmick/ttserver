# RailsAdmin config file. Generated on August 08, 2013 23:24
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Api', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Entry', 'Feed', 'Link', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Entry', 'Feed', 'Link', 'User']
  ...
  #     configure :id, :integer 
  #     configure :entry_id, :string 
  #     configure :published, :datetime 
  #     configure :updated, :datetime 
  ...
  #     configure :feed_id, :string 
  #     configure :updated, :datetime 
  #     configure :rights, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :source_url, :string 
  #     configure :source_type, :string 
  #     configure :provides_full_content, :boolean 
  ...
  #     configure :rel, :string 
  #     configure :url_type, :string 
  #     configure :hreflang, :string 
  #     configure :title, :string 
